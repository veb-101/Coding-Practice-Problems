...
(nRows and nCols, respectively), and the row and column you're sitting in, return
...
print(seatsInTheater(13, 6, 8, 3))
print(seatsInTheater(60, 100, 60, 1))
print(seatsInTheater(1000, 1000, 1000, 1000))
